...
Runs in Deno, Node.js, and the Browser. Get it from [deno.land](https://deno.land/x/froebel@v0.21.2) 
...
```ts
import { someUtility } from "https://deno.land/x/froebel@v0.21.2/mod.ts";
// or import just the utility you need:
import memoize from "https://deno.land/x/froebel@v0.21.2/memoize.ts"
```
...
/* Deno: */  import ident from "https://deno.land/x/froebel@v0.21.2/ident.ts";
```
...
/* Deno: */  import noop from "https://deno.land/x/froebel@v0.21.2/noop.ts";
```
...
/* Deno: */  import partial from "https://deno.land/x/froebel@v0.21.2/partial.ts";
```
...
/* Deno: */  import forward from "https://deno.land/x/froebel@v0.21.2/forward.ts";
```
...
/* Deno: */  import callAll from "https://deno.land/x/froebel@v0.21.2/callAll.ts";
```
...
/* Deno: */  import pipe from "https://deno.land/x/froebel@v0.21.2/pipe.ts";
```
...
/* Deno: */  import { applyPipe } from "https://deno.land/x/froebel@v0.21.2/pipe.ts";
```
...
/* Deno: */  import bundle from "https://deno.land/x/froebel@v0.21.2/bundle.ts";
```
...
/* Deno: */  import { bundleSync } from "https://deno.land/x/froebel@v0.21.2/bundle.ts";
```
...
/* Deno: */  import { nullishChain } from "https://deno.land/x/froebel@v0.21.2/nullishChain.ts";
```
...
/* Deno: */  import { asyncNullishChain } from "https://deno.land/x/froebel@v0.21.2/nullishChain.ts";
```
...
/* Deno: */  import throttle from "https://deno.land/x/froebel@v0.21.2/throttle.ts";
```
...
/* Deno: */  import debounce from "https://deno.land/x/froebel@v0.21.2/debounce.ts";
```
...
/* Deno: */  import memoize from "https://deno.land/x/froebel@v0.21.2/memoize.ts";
```
...
/* Deno: */  import { limitInvocations } from "https://deno.land/x/froebel@v0.21.2/invoke.ts";
```
...
/* Deno: */  import { once } from "https://deno.land/x/froebel@v0.21.2/invoke.ts";
```
...
/* Deno: */  import atWrap from "https://deno.land/x/froebel@v0.21.2/atWrap.ts";
```
...
/* Deno: */  import zip from "https://deno.land/x/froebel@v0.21.2/zip.ts";
```
...
/* Deno: */  import { zipWith } from "https://deno.land/x/froebel@v0.21.2/zip.ts";
```
...
/* Deno: */  import unzip from "https://deno.land/x/froebel@v0.21.2/unzip.ts";
```
...
/* Deno: */  import { unzipWith } from "https://deno.land/x/froebel@v0.21.2/unzip.ts";
```
...
/* Deno: */  import batch from "https://deno.land/x/froebel@v0.21.2/batch.ts";
```
...
/* Deno: */  import partition from "https://deno.land/x/froebel@v0.21.2/partition.ts";
```
...
/* Deno: */  import shuffle from "https://deno.land/x/froebel@v0.21.2/shuffle.ts";
```
...
/* Deno: */  import { shuffleInPlace } from "https://deno.land/x/froebel@v0.21.2/shuffle.ts";
```
...
/* Deno: */  import { take } from "https://deno.land/x/froebel@v0.21.2/list.ts";
```
...
/* Deno: */  import range from "https://deno.land/x/froebel@v0.21.2/range.ts";
```
...
/* Deno: */  import { numberRange } from "https://deno.land/x/froebel@v0.21.2/range.ts";
```
...
/* Deno: */  import { alphaRange } from "https://deno.land/x/froebel@v0.21.2/range.ts";
```
...
/* Deno: */  import repeat from "https://deno.land/x/froebel@v0.21.2/repeat.ts";
```
...
/* Deno: */  import { take } from "https://deno.land/x/froebel@v0.21.2/iterable.ts";
```
...
/* Deno: */  import pick from "https://deno.land/x/froebel@v0.21.2/pick.ts";
```
...
/* Deno: */  import omit from "https://deno.land/x/froebel@v0.21.2/omit.ts";
```
...
/* Deno: */  import map from "https://deno.land/x/froebel@v0.21.2/map.ts";
```
...
/* Deno: */  import select from "https://deno.land/x/froebel@v0.21.2/select.ts";
```
...
/* Deno: */  import oneOf from "https://deno.land/x/froebel@v0.21.2/oneOf.ts";
```
...
/* Deno: */  import equal from "https://deno.land/x/froebel@v0.21.2/equal.ts";
```
...
/* Deno: */  import clone from "https://deno.land/x/froebel@v0.21.2/clone.ts";
```
...
/* Deno: */  import promisify from "https://deno.land/x/froebel@v0.21.2/promisify.ts";
```
...
/* Deno: */  import createQueue from "https://deno.land/x/froebel@v0.21.2/queue.ts";
```
...
/* Deno: */  import isPromise from "https://deno.land/x/froebel@v0.21.2/isPromise.ts";
```
...
/* Deno: */  import { isNotPromise } from "https://deno.land/x/froebel@v0.21.2/isPromise.ts";
```
...
/* Deno: */  import { truthy } from "https://deno.land/x/froebel@v0.21.2/truthy.ts";
```
...
/* Deno: */  import { falsy } from "https://deno.land/x/froebel@v0.21.2/truthy.ts";
```
...
/* Deno: */  import { nullish } from "https://deno.land/x/froebel@v0.21.2/nullish.ts";
```
...
/* Deno: */  import { notNullish } from "https://deno.land/x/froebel@v0.21.2/nullish.ts";
```
...
/* Deno: */  import { isFulfilled } from "https://deno.land/x/froebel@v0.21.2/settled.ts";
```
...
/* Deno: */  import { isRejected } from "https://deno.land/x/froebel@v0.21.2/settled.ts";
```
...
/* Deno: */  import prefix from "https://deno.land/x/froebel@v0.21.2/prefix.ts";
```
...
/* Deno: */  import suffix from "https://deno.land/x/froebel@v0.21.2/suffix.ts";
```
...
/* Deno: */  import { surround } from "https://deno.land/x/froebel@v0.21.2/surround.ts";
```
...
/* Deno: */  import { capitalize } from "https://deno.land/x/froebel@v0.21.2/case.ts";
```
...
/* Deno: */  import { uncapitalize } from "https://deno.land/x/froebel@v0.21.2/case.ts";
```
...
/* Deno: */  import { upper } from "https://deno.land/x/froebel@v0.21.2/case.ts";
```
...
/* Deno: */  import { lower } from "https://deno.land/x/froebel@v0.21.2/case.ts";
```
...
/* Deno: */  import { snake } from "https://deno.land/x/froebel@v0.21.2/case.ts";
```
...
/* Deno: */  import { kebab } from "https://deno.land/x/froebel@v0.21.2/case.ts";
```
...
/* Deno: */  import { camel } from "https://deno.land/x/froebel@v0.21.2/case.ts";
```
...
/* Deno: */  import { pascal } from "https://deno.land/x/froebel@v0.21.2/case.ts";
```
...
/* Deno: */  import { screamingSnake } from "https://deno.land/x/froebel@v0.21.2/case.ts";
```
...
/* Deno: */  import { transformCase } from "https://deno.land/x/froebel@v0.21.2/case.ts";
```
...
/* Deno: */  import clamp from "https://deno.land/x/froebel@v0.21.2/clamp.ts";
```
...
/* Deno: */  import BiMap from "https://deno.land/x/froebel@v0.21.2/bimap.ts";
```
...
/* Deno: */  import SortedArray from "https://deno.land/x/froebel@v0.21.2/sortedArray.ts";
```
...
/* Deno: */  import SortedMap from "https://deno.land/x/froebel@v0.21.2/sortedMap.ts";
```
